#Original architecture is in my machine learning projects tab, but has been significantly revised to a decoder only Othello specific model
import torch
...
class ReversiBotDecoder(nn.Module):
    def __init__(self, vocab_size=64, embed_size=128, num_layers=4, heads=8,dropout=0.1,device='cuda',max_length=60, forward_expansion=4, num_classes=3):
        ...
        self.word_embedding.weight.data *= (embed_size ** -0.5)
    ...
    def forward(self, move_sequence, turns=None):
